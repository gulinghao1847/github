...
public class Fish {
	...
	public int id;
	  ...
	  private void evade()
	  {
		...
		if (x-xx>0 && dir_x<0) //if the blue fish is behind you and your going  toward it
			//then create new random trajectory away from fish
			dir_x=rn.nextFloat();
		...
		//Repeat for the opposite case if the fish is in front of you
		if (x-xx<0 && dir_x>0)
			dir_x=-rn.nextFloat();
	  ...
	  public void findfood()
	  {
		  ...
		  //locate the food in the tank if it exists, if it is close enough then move towards it
